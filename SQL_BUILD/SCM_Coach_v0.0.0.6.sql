 ...
 *
 * Date Created : Monday, March 06, 2023 14:09:27
...
CREATE TABLE drillLink(
    ...
    Caption        nvarchar(128)    NULL,
    CONSTRAINT PK_drillExLink PRIMARY KEY CLUSTERED (drillLinkID, drillID, drillExID)
)
go
...
ALTER TABLE drillLink ADD CONSTRAINT RefdrillEx97 
    FOREIGN KEY (drillExID)
    REFERENCES drillEx(drillExID)
go

ALTER TABLE drillLink ADD CONSTRAINT Refdrill98 
    FOREIGN KEY (drillID)
...
ALTER TABLE task ADD CONSTRAINT Refdrill96 
    FOREIGN KEY (drillID)
    REFERENCES drill(drillID)
go
