 ...
 * Author :       Artanemus
 *
 * Date Created : Thursday, June 01, 2023 13:15:20
...
VALUES
(1, N'25 Metres', N'25M', N'25', 0, 25),
(2, N'50 Metres', N'50M', N'50', 0, 50),
(3, N'100 Metres', N'100M', N'100', 0, 100),
(4, N'200 Metres', N'200M', N'200', 0, 200),
(5, N'400 Metres', N'400M', N'400', 0, 400),
(6, N'1000 Metres', N'1000M', N'1000', 0, 1000)
GO
...
IF OBJECT_ID('HRLink') IS NOT NULL
    PRINT '<<< CREATED TABLE HRLink >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE HRLink >>>'
go
...
VALUES
(1, N'Short Course Meters', 'ShortCourse', N'SCM',25.0)
, (2, N'Long Course', 'LongCourse', N'LCM',50.0)
, (3, N'Short Course Yards', 'ShortCourseY', N'SCY',22.86)
, (4, N'Long Course Yards', 'LongCourseY', N'LSCY', 100.584)
GO
...
,(3, 1, 2, 3, CAST(N'00:00:29' AS Time), 1, 1)
,(4, 1, 2, 4, CAST(N'00:00:26' AS Time), 1, 1)
,(5, 2, 3, 1, CAST(N'00:00:45' AS Time), 1, 1)
,(6, 2, 3, 2, CAST(N'00:01:00' AS Time), 1, 1)
,(7, 2, 3, 3, CAST(N'00:01:00' AS Time), 1, 1)
,(8, 2, 3, 4, CAST(N'00:00:55' AS Time), 1, 1)
,(9, 3, 3, 5, CAST(N'00:01:49' AS Time), 1, 1)
,(10, 4, 4, 5, CAST(N'00:03:45' AS Time), 1, 1)
,(11, 1, 2, 1, CAST(N'00:00:23' AS Time), 1, 2)
,(12, 1, 2, 2, CAST(N'00:00:31' AS Time), 1, 2)
,(13, 1, 2, 3, CAST(N'00:00:29' AS Time), 1, 2)
,(14, 1, 2, 4, CAST(N'00:00:26' AS Time), 1, 2)
,(15, 2, 3, 1, CAST(N'00:00:45' AS Time), 1, 2)
,(16, 2, 3, 2, CAST(N'00:01:00' AS Time), 1, 2)
,(17, 2, 3, 3, CAST(N'00:01:00' AS Time), 1, 2)
,(18, 2, 3, 4, CAST(N'00:00:55' AS Time), 1, 2)
,(19, 3, 3, 5, CAST(N'00:01:49' AS Time), 1, 2)
,(20, 4, 4, 5, CAST(N'00:03:48' AS Time), 1, 2)
,(21, 1, 2, 1, CAST(N'00:00:24' AS Time), 2, 1)
,(22, 1, 2, 2, CAST(N'00:00:32' AS Time), 2, 1)
,(23, 1, 2, 3, CAST(N'00:00:30' AS Time), 2, 1)
,(24, 1, 2, 4, CAST(N'00:00:27' AS Time), 2, 1)
,(25, 2, 3, 1, CAST(N'00:00:46' AS Time), 2, 1)
,(26, 2, 3, 2, CAST(N'00:01:01' AS Time), 2, 1)
,(27, 2, 3, 3, CAST(N'00:01:01' AS Time), 2, 1)
,(28, 2, 3, 4, CAST(N'00:00:56' AS Time), 2, 1)
,(29, 3, 3, 5, CAST(N'00:01:50' AS Time), 2, 1)
,(30, 4, 4, 5, CAST(N'00:03:46' AS Time), 2, 1)
,(31, 1, 2, 1, CAST(N'00:00:24' AS Time), 2, 2)
,(32, 1, 2, 2, CAST(N'00:00:32' AS Time), 2, 2)
,(33, 1, 2, 3, CAST(N'00:00:30' AS Time), 2, 2)
,(34, 1, 2, 4, CAST(N'00:00:27' AS Time), 2, 2)
,(35, 2, 3, 1, CAST(N'00:00:46' AS Time), 2, 2)
,(36, 2, 3, 2, CAST(N'00:01:01' AS Time), 2, 2)
,(37, 2, 3, 3, CAST(N'00:01:01' AS Time), 2, 2)
,(38, 2, 3, 4, CAST(N'00:00:56' AS Time), 2, 2)
,(39, 3, 3, 5, CAST(N'00:01:50' AS Time), 2, 2)
...
(
[SCMSystemID] -- Only one record allowed - ALWAYS 1 
 ,[DBVersion] -- 1:MSSQL, 2:MYSQL, , ETC
 ,[Major]
 ,[Minor]
)
VALUES (
...
GO
INSERT [dbo].[SessionStatus] ([SessionStatusID], [Caption]) VALUES (1, N'Unlocked')
GO
...
INSERT INTO [dbo].[Stroke]
           ...
           ,[IsArchived])
     VALUES
           (1,'FreeStyle','Free','FR',0)
           ,(2,'BackStroke','Back','BK',0)
           ,(3,'BreastStroke','Breast','BR',0)
           ,(4,'ButterFly','Fly','BF',0)
           ,(5,'IndvMedly','IMedly','IM',0)
GO
...
CREATE TABLE SwimClub(
    ...
    EnableSimpleDisqualify    bit              DEFAULT 0 NULL,
...
ALTER TABLE Entrant ADD CONSTRAINT HRLinkEntrant 
...
ALTER TABLE HRLink ADD CONSTRAINT MemberHRLink 
    FOREIGN KEY (MemberID)
...
ALTER TABLE Qualify ADD CONSTRAINT PoolTypeQualify 
...
ALTER TABLE TeamEntrant ADD CONSTRAINT HRLinkTeamEntrant 
    FOREIGN KEY (SwimClubID, MemberID)
    REFERENCES HRLink(SwimClubID, MemberID)
go
